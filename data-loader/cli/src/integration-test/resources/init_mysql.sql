-- ============================================================================
-- MySQL Database Initialization Script for Export Tests
-- ============================================================================
-- This script is used by BaseIntegrationTest for export tests.
-- It includes:
...
-- Related: init_mysql_import.sql (similar structure but no employee data)
-- ============================================================================
...
--       init_mysql_import.sql has the same table structure but NO data.
