...
/**
 * Integration tests for JSON Lines (JSONL) import functionality using PostgreSQL.
 *
 ...
 */
public class ImportCommandJsonLinesPostgreSQLIT extends BasePostgreSQLIntegrationTest {
