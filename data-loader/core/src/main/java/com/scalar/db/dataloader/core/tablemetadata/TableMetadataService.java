...
import static com.scalar.db.dataloader.core.ErrorMessage.TABLE_METADATA_RETRIEVAL_FAILED;
    ...
    try {
      ...
      if (tableMetadata == null) {
        throw new TableMetadataException(
            String.format(MISSING_NAMESPACE_OR_TABLE, namespace, tableName));
      }
      return tableMetadata;
    } catch (ExecutionException e) {
      throw new TableMetadataException(
          String.format(TABLE_METADATA_RETRIEVAL_FAILED, e.getMessage()), e);
    }
  }
