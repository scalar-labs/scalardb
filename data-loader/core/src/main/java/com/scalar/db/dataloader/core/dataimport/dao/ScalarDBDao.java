...
import static com.scalar.db.dataloader.core.ErrorMessage.ERROR_CRUD_EXCEPTION;
import static com.scalar.db.dataloader.core.ErrorMessage.ERROR_SCAN;
...
public class ScalarDBDao {
  ...
  public void put(
    ...
    try {
      ...
      throw new ScalarDBDaoException(String.format(ERROR_CRUD_EXCEPTION, e.getMessage()), e);
    }
  ...
  public List<Result> scan(
    ...
    try {
      ...
      throw new ScalarDBDaoException(String.format(ERROR_SCAN, e.getMessage()), e);
    }
  }
