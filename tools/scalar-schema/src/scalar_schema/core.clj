...
(def cli-options
  [[nil "--cassandra" "Operate for Cassandra"]
   ...
   [nil "--jdbc" "Operate for JDBC database"]
   ...
   ["-p" "--password ACCOUNT_PASSWORD" "Password of Cassandra or Cosmos DB or JDBC database account"]
   ...
   ["-j" "--jdbc-url JDBC_URL" "JDBC URL for JDBC database"]
   [nil "--help"]])
