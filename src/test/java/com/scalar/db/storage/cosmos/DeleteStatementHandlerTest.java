...
public class DeleteStatementHandlerTest {
  ...
  @Test
  public void execute_DeleteWithoutConditions_ShouldCallDeleteItem() {
    // Arrange
  ...
  @Test
  public void execute_DeleteWithoutConditionsCosmosExceptionThrown_ShouldThrowExecutionException() {
    // Arrange
    Delete delete = prepareDelete();
  ...
  @Test
  public void execute_DeleteWithConditions_ShouldCallStoredProcedure() {
    // Arrange
    ...
    verify(storedProcedure)
        .execute(eq(Arrays.asList(query)), any(CosmosStoredProcedureRequestOptions.class));
  }

  @Test
  public void execute_DeleteWithConditionsReturnFalseResponse_ThrowNoMutationException() {
    // Arrange
    when(container.getScripts()).thenReturn(cosmosScripts);
    when(cosmosScripts.getStoredProcedure(anyString())).thenReturn(storedProcedure);
    when(storedProcedure.execute(any(List.class), any(CosmosStoredProcedureRequestOptions.class)))
  ...
  @Test
  public void execute_DeleteWithConditionCosmosExceptionThrown_ThrowExecutionException() {
    // Arrange
    when(container.getScripts()).thenReturn(cosmosScripts);
    when(cosmosScripts.getStoredProcedure(anyString())).thenReturn(storedProcedure);
    CosmosException toThrow = mock(CosmosException.class);
