...
public class SchemaUtilsTest {
  ...
  @Test
  public void dataTypeToGraphQLScalarType_BigIntGiven_ShouldThrowIllegalArgumentException() {
    // Act Assert
    assertThatThrownBy(() -> SchemaUtils.dataTypeToGraphQLScalarType(DataType.BIGINT))
