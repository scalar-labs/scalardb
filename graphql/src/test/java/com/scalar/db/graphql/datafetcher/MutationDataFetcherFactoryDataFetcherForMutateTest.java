...
public class MutationDataFetcherFactoryDataFetcherForMutateTest extends DataFetcherTestBase {
  ...
  public void setUp() {
    ...
    dataFetcher = dataFetcherFactory::dataFetcherForMutate;
    ...
    List<Map<String, Object>> deleteInput =
        ImmutableList.of(ImmutableMap.of("key", ImmutableMap.of(COL1, 2, COL2, "B")));
  ...
  public void get_WhenOperationSucceeds_ShouldReturnTrue() throws Exception {
    // Arrange
    doNothing().when(dataFetcherFactory).performMutate(eq(dataFetchingEnvironment), anyList());
  ...
  public void get_WhenOperationFails_ShouldReturnFalseWithErrors() throws Exception {
    ...
    doThrow(exception)
        ...
        .performMutate(eq(dataFetchingEnvironment), anyList());
