...
public class MutationDataFetcherFactoryDataFetcherForDeleteTest extends DataFetcherTestBase {
  ...
  public void setUp() {
    ...
    dataFetcher = dataFetcherFactory::dataFetcherForDelete;

    // table1_delete(delete: {
    //   key: { c1: 1, c2: "A" }
    // })
    Map<String, Object> putInput = ImmutableMap.of("key", ImmutableMap.of(COL1, 1, COL2, "A"));
    when(dataFetchingEnvironment.getArgument("delete")).thenReturn(putInput);
  }
  ...
  public void get_WhenOperationSucceeds_ShouldReturnTrue() throws Exception {
    ...
    doNothing()
        ...
        .performDelete(eq(dataFetchingEnvironment), any(Delete.class));
