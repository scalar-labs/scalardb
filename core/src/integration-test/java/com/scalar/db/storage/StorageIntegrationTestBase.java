...
public abstract class StorageIntegrationTestBase {
  ...
  public void put_PutWithNullValue_ShouldPutProperly() throws ExecutionException {
    ...
    assertThat(result.getObject(COL_NAME1)).isEqualTo(0);
    ...
    assertThat(result.getObject(COL_NAME4)).isEqualTo(0);
    ...
    assertThat(result.getObject(COL_NAME2)).isNull();
    ...
    assertThat(result.getObject(COL_NAME3)).isEqualTo(0);
    ...
    assertThat(result.getObject(COL_NAME5)).isEqualTo(true);
  }
