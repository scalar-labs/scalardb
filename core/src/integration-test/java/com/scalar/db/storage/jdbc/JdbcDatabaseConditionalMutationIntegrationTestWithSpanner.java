...
/**
 * Spanner-specific conditional mutation integration test that works around the Spanner emulator's
 * single-transaction-at-a-time limitation by giving each thread its own database.
 *
 * <p>This class is only enabled when running against a Spanner JDBC URL. It overrides {@link
