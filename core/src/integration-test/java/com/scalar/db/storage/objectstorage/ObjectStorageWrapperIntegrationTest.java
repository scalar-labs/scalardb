...
public class ObjectStorageWrapperIntegrationTest {
  ...
  private static final byte[] TEST_OBJECT1 =
      "test-object1".getBytes(java.nio.charset.StandardCharsets.UTF_8);
  private static final byte[] TEST_OBJECT2 =
      "test-object2".getBytes(java.nio.charset.StandardCharsets.UTF_8);
  private static final byte[] TEST_OBJECT3 =
      "test-object3".getBytes(java.nio.charset.StandardCharsets.UTF_8);
  ...
  public void insert_NewObjectKeyGiven_ShouldInsertObjectSuccessfully() throws Exception {
    ...
    byte[] object = "new-object".getBytes(java.nio.charset.StandardCharsets.UTF_8);
  ...
  public void insert_ExistingObjectKeyGiven_ShouldThrowPreconditionFailedException() {
    ...
    assertThatCode(
            () ->
                wrapper.insert(
                    TEST_KEY2, "another-object".getBytes(java.nio.charset.StandardCharsets.UTF_8)))
  ...
  public void update_ExistingObjectKeyGiven_ShouldUpdateObjectSuccessfully() throws Exception {
    // Arrange
    byte[] updatedObject = "updated-object2".getBytes(java.nio.charset.StandardCharsets.UTF_8);
  ...
  public void update_NonExistingObjectKeyGiven_ShouldThrowPreconditionFailedException() {
    ...
    assertThatCode(
            () ->
                wrapper.update(
                    objectKey,
                    "some-object".getBytes(java.nio.charset.StandardCharsets.UTF_8),
                    "123456789"))
        .isInstanceOf(PreconditionFailedException.class);
  }
  ...
  public void update_WrongVersionGiven_ShouldThrowPreconditionFailedException() {
    ...
    assertThatCode(
            () ->
                wrapper.update(
                    TEST_KEY2,
                    "another-object".getBytes(java.nio.charset.StandardCharsets.UTF_8),
                    wrongVersion))
        .isInstanceOf(PreconditionFailedException.class);
  }
  ...
  public void getKeys_WithPrefixForTheNumberOfObjectsExceedingTheListLimit_ShouldReturnAllKeys()
    ...
    try {
      ...
      for (int i = 0; i < numberOfObjects; i++) {
        wrapper.insert(
            prefix + i, ("object-" + i).getBytes(java.nio.charset.StandardCharsets.UTF_8));
      }
