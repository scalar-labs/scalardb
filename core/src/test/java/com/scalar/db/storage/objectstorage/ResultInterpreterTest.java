...
public class ResultInterpreterTest {
  ...
  public void interpret_ShouldReturnWhatsSet() {
    ...
    Map<String, Object> values =
        ImmutableMap.<String, Object>builder()
            ...
            .put(
                ANY_COLUMN_NAME_9,
                TimeRelatedColumnEncodingUtils.encode(TimeColumn.of(ANY_COLUMN_NAME_9, ANY_TIME)))
            .put(
                ANY_COLUMN_NAME_10,
  ...
  public void interpret_ShouldReturnWhatsSetWithNullValues() {
    ...
    values.put(ANY_COLUMN_NAME_1, null);
    values.put(ANY_COLUMN_NAME_2, null);
    values.put(ANY_COLUMN_NAME_3, null);
    values.put(ANY_COLUMN_NAME_4, null);
    values.put(ANY_COLUMN_NAME_5, null);
    values.put(ANY_COLUMN_NAME_6, null);
    values.put(ANY_COLUMN_NAME_7, null);
    values.put(ANY_COLUMN_NAME_8, null);
    values.put(ANY_COLUMN_NAME_9, null);
    values.put(ANY_COLUMN_NAME_10, null);
    values.put(ANY_COLUMN_NAME_11, null);
    ObjectStorageRecord record =
        new ObjectStorageRecord(
            ANY_ID_1,
            ImmutableMap.of(ANY_NAME_1, ANY_TEXT_1),
