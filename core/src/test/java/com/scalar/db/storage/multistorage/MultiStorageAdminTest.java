...
public class MultiStorageAdminTest {
  ...
  public void createVirtualTable_ProperArgumentsGiven_ShouldCallAdminProperly()
    ...
    StorageInfo storageInfo =
        new StorageInfoImpl("s2", StorageInfo.AtomicityUnit.NAMESPACE, Integer.MAX_VALUE, true);
  ...
  public void
    ...
    StorageInfo storageInfoForNamespace =
        new StorageInfoImpl("s3", StorageInfo.AtomicityUnit.NAMESPACE, Integer.MAX_VALUE, true);
