...
public class ObjectStorageTest {
  ...
  @Mock private MutateStatementHandler mutateStatementHandler;
  ...
  public void setUp() throws Exception {
    ...
    Properties objectStorageConfigProperties = new Properties();
    objectStorage =
        new ObjectStorage(
            new DatabaseConfig(objectStorageConfigProperties),
            wrapper,
  ...
  public void get_WithoutConjunction_ShouldHandledWithOriginalGet() throws ExecutionException {
    ...
    // Act
    Optional<Result> actual = objectStorage.get(get);
  ...
  public void scan_WithLimitWithoutConjunction_ShouldHandledWithLimit() throws ExecutionException {
    ...
    // Act
    Scanner actual = objectStorage.scan(scan);
  ...
  public void
    ...
    // Act Assert
    assertThatThrownBy(() -> objectStorage.get(get)).isInstanceOf(IllegalArgumentException.class);
  }
  ...
  public void
    ...
    // Act Assert
    assertThatThrownBy(() -> objectStorage.put(put)).isInstanceOf(IllegalArgumentException.class);
  }
  ...
  public void
    ...
    // Act Assert
    assertThatThrownBy(() -> objectStorage.put(Arrays.asList(put1, put2)))
  ...
  public void
    ...
    // Act Assert
    assertThatThrownBy(() -> objectStorage.delete(delete))
        .isInstanceOf(IllegalArgumentException.class);
  }
  ...
  public void
    ...
    // Act Assert
    assertThatThrownBy(() -> objectStorage.delete(Arrays.asList(delete1, delete2)))
        .isInstanceOf(IllegalArgumentException.class);
  }
