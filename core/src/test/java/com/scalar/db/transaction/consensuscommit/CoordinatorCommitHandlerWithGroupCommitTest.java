...
class CoordinatorCommitHandlerWithGroupCommitTest {
  ...
  void setUp() throws Exception {
    ...
    // The handler's constructor wires the Emitter into the groupCommitter via setEmitter().
    handler = new CoordinatorCommitHandlerWithGroupCommit(coordinator, groupCommitter);
