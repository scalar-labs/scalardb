...
public class GrpcTransactionAdminTest {

  @Mock private GrpcConfig config;
  @Mock private DistributedTransactionAdminGrpc.DistributedTransactionAdminBlockingStub stub;

  private GrpcTransactionAdmin admin;
  ...
  public void setUp() throws Exception {
    ...
    // Arrange
    admin = new GrpcTransactionAdmin(stub, config);
  ...
  @Test
  public void createCoordinatorTables_CalledWithProperArguments_StubShouldBeCalledProperly()
      throws ExecutionException {
    // Arrange

    // Act
    admin.createCoordinatorTables(true, Collections.emptyMap());
    ...
    verify(stub)
        .createCoordinatorTables(
            CreateCoordinatorTablesRequest.newBuilder()
                .setIfNotExist(true)
                .putAllOptions(Collections.emptyMap())
                .build());
  }

  @Test
  public void dropCoordinatorTables_CalledWithProperArguments_StubShouldBeCalledProperly()
      throws ExecutionException {
    // Arrange
    ...
    // Assert
    verify(stub)
        .dropCoordinatorTables(DropCoordinatorTablesRequest.newBuilder().setIfExist(true).build());
  }

  @Test
  public void truncateCoordinatorTables_CalledWithProperArguments_StubShouldBeCalledProperly()
      throws ExecutionException {
    // Arrange
    ...
    // Assert
    verify(stub).truncateCoordinatorTables(TruncateCoordinatorTablesRequest.getDefaultInstance());
  }

  @Test
  public void coordinatorTablesExist_CalledWithProperArguments_StubShouldBeCalledProperly()
      throws ExecutionException {
    // Arrange
    CoordinatorTablesExistResponse response = mock(CoordinatorTablesExistResponse.class);
    when(stub.coordinatorTablesExist(any())).thenReturn(response);
    when(response.getExist()).thenReturn(true);
