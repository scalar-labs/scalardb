...
public class TransactionResultTest {
  ...
  public void getValue_ResultGiven_ShouldReturnCorrectValue() {
    ...
    assertThat(result.getObject(ANY_NAME_3)).isEqualTo(ANY_INT_2);
    ...
    assertThat(result.getObject(Attribute.ID)).isEqualTo(ANY_ID_2);
    ...
    assertThat(result.getObject(Attribute.PREPARED_AT)).isEqualTo(ANY_TIME_3);
    ...
    assertThat(result.getObject(Attribute.COMMITTED_AT)).isEqualTo(ANY_TIME_4);
    ...
    assertThat(result.getObject(Attribute.STATE)).isEqualTo(TransactionState.COMMITTED.get());
    ...
    assertThat(result.getObject(Attribute.VERSION)).isEqualTo(ANY_VERSION_2);
    ...
    assertThat(result.getObject(Attribute.BEFORE_PREFIX + ANY_NAME_3)).isEqualTo(ANY_INT_1);
    ...
    assertThat(result.getObject(Attribute.BEFORE_ID)).isEqualTo(ANY_ID_1);
    ...
    assertThat(result.getObject(Attribute.BEFORE_PREPARED_AT)).isEqualTo(ANY_TIME_1);
    ...
    assertThat(result.getObject(Attribute.BEFORE_COMMITTED_AT)).isEqualTo(ANY_TIME_2);
    ...
    assertThat(result.getObject(Attribute.BEFORE_STATE))
    ...
    assertThat(result.getObject(Attribute.BEFORE_VERSION)).isEqualTo(ANY_VERSION_1);
  }
