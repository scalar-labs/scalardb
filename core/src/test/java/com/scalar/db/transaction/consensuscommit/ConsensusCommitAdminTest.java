...
public class ConsensusCommitAdminTest {
  ...
  public void
    ...
    // Act
    boolean actual = ConsensusCommitAdmin.isTransactionalTableMetadata(metadata);
  ...
  public void
    ...
    // Act
    TableMetadata actual = ConsensusCommitAdmin.removeTransactionalMetaColumns(metadata);
