...
public class FilteredResultTest {
  ...
  public void withoutProjections_ShouldFilterOutTransactionMetaColumns() {
    ...
    assertThat(filteredResult.getObject(ACCOUNT_ID)).isEqualTo(0);
    ...
    assertThat(filteredResult.getObject(ACCOUNT_TYPE)).isEqualTo(1);
    ...
    assertThat(filteredResult.getObject(BALANCE)).isEqualTo(2);
