...
public class JdbcTransactionAdminTest {
  ...
  @Test
  public void repairTableWithBeforeAfterState_ShouldCallJdbcAdminProperly()
    ...
    // Assert
    verify(jdbcAdmin).repairTable(namespace, oldTable, oldMetadata, newTable, newMetadata, options);
  }
