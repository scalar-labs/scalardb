...
//    // Act Assert
//    assertThatThrownBy(() ->
// manager.getState(ANY_ID)).isInstanceOf(IllegalArgumentException.class);
//  }
//
//  @Test
...
//    // Act　Assert
//    assertThatThrownBy(() ->
// transaction.delete(delete)).isInstanceOf(CrudConflictException.class);
//  }
//
//  @Test
...
//    // Act　Assert
//    assertThatThrownBy(() ->
// transaction.delete(deletes)).isInstanceOf(CrudConflictException.class);
//  }
//
//  @Test
