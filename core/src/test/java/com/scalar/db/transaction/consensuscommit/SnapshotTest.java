...
public class SnapshotTest {
  ...
  public void get_KeyGivenContainedInWriteSetAndReadSet_ShouldReturnMergedResult()
    ...
    assertThat(actual.get().getObject(ANY_NAME_1)).isEqualTo(ANY_TEXT_1);
    ...
    assertThat(actual.get().getObject(ANY_NAME_2)).isEqualTo(ANY_TEXT_2);
    ...
    assertThat(actual.get().getObject(ANY_NAME_3)).isEqualTo(ANY_TEXT_5);
    ...
    assertThat(actual.get().getObject(ANY_NAME_4)).isNull();
    ...
    assertThat(actual.get().getObject(Attribute.ID)).isEqualTo(ANY_ID);
    ...
    assertThat(actual.get().getObject(Attribute.VERSION)).isEqualTo(ANY_VERSION);
  }
