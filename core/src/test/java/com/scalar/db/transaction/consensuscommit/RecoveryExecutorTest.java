...
public class RecoveryExecutorTest {
  ...
  public void
    ...
    Optional<TransactionResult> recoveredResult = result.recoveryFuture.get();

    // Assert
    assertThat(result.recoveredResult).hasValue(prepareRolledBackResult());
    assertThat(recoveredResult).hasValue(prepareRolledBackResult());
  ...
  public void
    ...
    assertThat(recoveredResult).isEmpty();
    verify(recovery).recover(eq(selection), eq(transactionResult), eq(Optional.empty()));
  }
  ...
  public void
    ...
    assertThat(recoveredResult).hasValue(prepareRolledForwardResult());
  ...
  public void
    ...
    assertThat(recoveredResult).isNotPresent();
    verify(recovery).recover(eq(selection), eq(transactionResult), eq(Optional.of(commitState)));
  }
