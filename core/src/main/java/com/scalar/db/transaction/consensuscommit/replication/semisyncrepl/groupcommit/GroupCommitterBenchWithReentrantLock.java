...
class GroupCommitterBenchWithReentrantLock {
  ...
  Result benchmarkInternal(
    ...
    try (GroupCommitter3WithReentrantLock<String, Value> groupCommitter =
        new GroupCommitter3WithReentrantLock<>(
            "test",
  ...
  public static void main(String[] args)
    ...
    new GroupCommitterBenchWithReentrantLock().benchmark(microBenchmark);
  }
}
