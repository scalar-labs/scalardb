 ...
 * fields list. Built on {@link OrderedBytes#encodeBlobVar(PositionedByteRange, byte[], int, int,
 * Order)}.
 */
@InterfaceAudience.Public
public class OrderedBlobVar extends OrderedBytesBase<byte[]> {
  /** @deprecated since 3.0.0 and will be removed in 4.0.0 */
  @Deprecated public static final OrderedBlobVar ASCENDING = new OrderedBlobVar(Order.ASCENDING);
  /** @deprecated since 3.0.0 and will be removed in 4.0.0 */
  @Deprecated public static final OrderedBlobVar DESCENDING = new OrderedBlobVar(Order.DESCENDING);
