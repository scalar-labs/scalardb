...
public class RawString implements DataType<String> {
  ...
  @Deprecated public static final RawString ASCENDING = new RawString(Order.ASCENDING);
  /** @deprecated since 3.0.0 and will be removed in 4.0.0 */
  @Deprecated public static final RawString DESCENDING = new RawString(Order.DESCENDING);
  ...
  /**
   * Creates a new {@link DataType} for interacting with values encoded using {@link
