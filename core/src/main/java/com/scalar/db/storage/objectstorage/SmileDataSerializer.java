...
public class SmileDataSerializer implements ObjectStorageDataSerializer {
  ...
  public byte[] serialize(ObjectStoragePartition partition) {
    try {
      ...
      throw new RuntimeException("Failed to serialize the partition to Smile.", e);
    }
  }
  ...
  public ObjectStoragePartition deserialize(byte[] data) {
    try {
      ...
      throw new RuntimeException("Failed to deserialize the partition from Smile.", e);
    }
  }
}
