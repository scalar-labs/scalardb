...
public class CborDataSerializer implements ObjectStorageDataSerializer {
  ...
  public byte[] serialize(ObjectStoragePartition partition) {
    try {
      ...
      throw new RuntimeException("Failed to serialize the partition to CBOR.", e);
    }
  }
  ...
  public ObjectStoragePartition deserialize(byte[] data) {
    try {
      ...
      throw new RuntimeException("Failed to deserialize the partition from CBOR.", e);
    }
  }
}
