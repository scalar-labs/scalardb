...
public class JdbcConfig {
  ...
  public static final String DB2_VARIABLE_KEY_COLUMN_SIZE =
      PREFIX + "db2.variable_key_column_size";
  ...
  public JdbcConfig(DatabaseConfig databaseConfig) {
    ...
    if (mysqlVariableKeyColumnSize < MINIMUM_VARIABLE_KEY_COLUMN_SIZE
        || oracleVariableKeyColumnSize < MINIMUM_VARIABLE_KEY_COLUMN_SIZE || db2VariableKeyColumnSize < MINIMUM_VARIABLE_KEY_COLUMN_SIZE) {
