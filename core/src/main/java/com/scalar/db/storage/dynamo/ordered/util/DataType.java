 ...
 *
 * <p>Data type instances are designed to be stateless, thread-safe, and reused. Implementations
 * should provide {@code static final} instances corresponding to each variation on configurable
...
public interface DataType<T> {
   ...
   * preserved. Value is either ascending or descending. Default is assumed to be {@link
   * Order#ASCENDING}.
   */
  Order getOrder();
