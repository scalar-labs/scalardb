...
/**
 * A {@code byte[]} of variable-length. Build on {@link
...
public class OrderedBlob extends OrderedBytesBase<byte[]> {
  ...
  @Deprecated public static final OrderedBlob ASCENDING = new OrderedBlob(Order.ASCENDING);
  /** @deprecated since 3.0.0 and will b removed in 4.0.0 */
  @Deprecated public static final OrderedBlob DESCENDING = new OrderedBlob(Order.DESCENDING);
