...
public class ObjectStorageTableMetadata {
  ...
  public ObjectStorageTableMetadata(TableMetadata tableMetadata) {
    ...
    this.partitionKeyNames = new LinkedHashSet<>(tableMetadata.getPartitionKeyNames());
    this.clusteringKeyNames = new LinkedHashSet<>(tableMetadata.getClusteringKeyNames());
    this.clusteringOrders = clusteringOrders;
    this.secondaryIndexNames = new HashSet<>(tableMetadata.getSecondaryIndexNames());
