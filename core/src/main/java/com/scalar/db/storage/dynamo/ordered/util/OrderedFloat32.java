...
/**
 * A {@code float} of 32-bits using a fixed-length encoding. Based on {@link
...
public class OrderedFloat32 extends OrderedBytesBase<Float> {
  ...
  @Deprecated public static final OrderedFloat32 ASCENDING = new OrderedFloat32(Order.ASCENDING);
  /** @deprecated since 3.0.0 and will be removed in 4.0.0 */
  @Deprecated public static final OrderedFloat32 DESCENDING = new OrderedFloat32(Order.DESCENDING);
