 ...
 * data type anywhere you would expect to use a {@code DECIMAL} type, a {@link BigDecimal}, a {@link
 * BigInteger}, or any time you've parsed floating precision values from text. Built on {@link
...
public class OrderedNumeric extends OrderedBytesBase<Number> {
  ...
  @Deprecated public static final OrderedNumeric ASCENDING = new OrderedNumeric(Order.ASCENDING);
  /** @deprecated since 3.0.0 and will be removed in 4.0.0 */
  @Deprecated public static final OrderedNumeric DESCENDING = new OrderedNumeric(Order.DESCENDING);
