...
/**
 * An {@code DataType} for interacting with values encoded using {@link Bytes#putInt(byte[], int,
 * int)}. Intended to make it easier to transition away from direct use of {@link Bytes}.
 *
