...
/**
 * An {@code int} of 32-bits using a fixed-length encoding. Built on {@link
...
public class OrderedInt32 extends OrderedBytesBase<Integer> {
  ...
  @Deprecated public static final OrderedInt32 ASCENDING = new OrderedInt32(Order.ASCENDING);
  /** @deprecated since 3.0.0 and will be removed in 4.0.0 */
  @Deprecated public static final OrderedInt32 DESCENDING = new OrderedInt32(Order.DESCENDING);
