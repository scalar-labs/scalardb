...
/**
 * A {@code long} of 64-bits using a fixed-length encoding. Built on {@link
...
public class OrderedInt64 extends OrderedBytesBase<Long> {
  ...
  @Deprecated public static final OrderedInt64 ASCENDING = new OrderedInt64(Order.ASCENDING);
  /** @deprecated since 3.0.0 and will be removed in 4.0.0 */
  @Deprecated public static final OrderedInt64 DESCENDING = new OrderedInt64(Order.DESCENDING);
