 ...
 * in {@link #compareTo(ByteRange)}, {@link #hashCode()}, or {@link #equals(Object)}. {@code
...
public abstract class AbstractPositionedByteRange extends AbstractByteRange
   ...
   *
   * <p>Position is considered transient and does not participate in {@link #equals(Object)} or
   ...
   * bytes.length}. Resets {@code position} to 0.
   *
   ...
   * bytes.length}. If {@code position} is greater than the new {@code length}, sets {@code
   * position} to {@code length}.
   *
