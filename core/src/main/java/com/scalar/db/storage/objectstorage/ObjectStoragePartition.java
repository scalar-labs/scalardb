...
public class ObjectStoragePartition {
  ...
  public static ObjectStoragePartition deserialize(
      byte[] serializedObject, TableMetadata metadata) {
    return ParquetSerializer.deserialize(serializedObject, metadata);
  }
  ...
  public byte[] serialize(TableMetadata metadata) {
    return ParquetSerializer.serialize(this, metadata);
  }
