...
/**
 * A {@code double} of 64-bits using a fixed-length encoding. Built on {@link
...
public class OrderedFloat64 extends OrderedBytesBase<Double> {
  ...
  @Deprecated public static final OrderedFloat64 ASCENDING = new OrderedFloat64(Order.ASCENDING);
  /** @deprecated since 3.0.0 and will be removed in 4.0.0 */
  @Deprecated public static final OrderedFloat64 DESCENDING = new OrderedFloat64(Order.DESCENDING);
