...
/**
 * A {@code byte} of 8-bits using a fixed-length encoding. Built on {@link
...
public class OrderedInt8 extends OrderedBytesBase<Byte> {
  ...
  @Deprecated public static final OrderedInt8 ASCENDING = new OrderedInt8(Order.ASCENDING);
  /** @deprecated since 3.0.0 and will be removed in 4.0.0 */
  @Deprecated public static final OrderedInt8 DESCENDING = new OrderedInt8(Order.DESCENDING);
