...
/**
 * A {@code String} of variable-length. Built on {@link
...
public class OrderedString extends OrderedBytesBase<String> {
  ...
  @Deprecated public static final OrderedString ASCENDING = new OrderedString(Order.ASCENDING);
  /** @deprecated since 3.0.0 and will be removed in 4.0.0 */
  @Deprecated public static final OrderedString DESCENDING = new OrderedString(Order.DESCENDING);
