...
/**
 * A {@code short} of 16-bits using a fixed-length encoding. Built on {@link
...
public class OrderedInt16 extends OrderedBytesBase<Short> {
  ...
  @Deprecated public static final OrderedInt16 ASCENDING = new OrderedInt16(Order.ASCENDING);
  /** @deprecated since 3.0.0 and will be removed in 4.0.0 */
  @Deprecated public static final OrderedInt16 DESCENDING = new OrderedInt16(Order.DESCENDING);
