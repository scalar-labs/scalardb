...
# If set to "true", Get and Scan operations results will contain transaction metadata. It can be useful to investigate transaction related issues. The default is "false".
