...
[ScalarDB Server](scalardb-server.md) is a standalone server that provides a gRPC interface to Scalar DB.
...
Other than the default transaction manager Consensus Commit, Scalar DB supports JDBC transactions.
